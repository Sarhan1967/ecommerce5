...
class ShoppingController extends GetxController {
  ...
  var latestProducts = <ItemModel>[].obs;
  var topProducts = <ItemModel>[].obs;
  var sponseredProducts = <ItemModel>[].obs;
  var exclusiveProducts = <ItemModel>[].obs;
  var latestProductsIndex = <int>[].obs;
  var topProductsIndex = <int>[].obs;
  var sponseredProductsIndex = <int>[].obs;
  var exclusiveProductsIndex = <int>[].obs;
